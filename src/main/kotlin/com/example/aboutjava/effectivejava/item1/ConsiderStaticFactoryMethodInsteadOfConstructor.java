 ...
 * - 대표적인 예로, {@link Collections Collections Class}가 있습니다.<p>
 ...
 * <p>
 * 결론)<p>
 * - "정적 팩토리 메서드", "public new 생성자"는 각자 쓰임이 있으니 필요에 따라 맞게 사용하면 됩니다.<p>
 * - 대부분은 "public new 생성자"보다 "정적 팩터리 메서드"를 사용하는 게 유리할 때가 많습니다.<p>
 */
