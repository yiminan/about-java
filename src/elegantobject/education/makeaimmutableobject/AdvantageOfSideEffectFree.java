...
/**
 * "불변 객체 사용하여 가변 객체의 사이드 이펙트를 제거한다"
 * 가변 객체는 객체가 수정될 여지가 있습니다. 결국 개발자가 객체를 잘못 다룰 가능성이 존재합니다.
 * 하지만 불변 객체를 사용하면 중간에 객체가 수정될 가능성은 없습니다. 객체의 불변을 보장하여 신뢰있는 객체를 사용할 수 있습니다.
 */
