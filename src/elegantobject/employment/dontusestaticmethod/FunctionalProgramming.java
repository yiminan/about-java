 ...
 * 함수형 프로그래밍(functional programming, FP)을 활용하는 편이 더 낫다라는 이야기가 나옵니다.
 * 하지만
 * (1) OOP가 표현력이 더 좋고, 객체와 메서드를 조합할 수 있습니다.
 * (2) FP는 함수만 제공합니다.
 * 최근에는 Java8에서 람다 표현식이 제공되어 편리하지만, OOP에서 더욱 멀어져서 견고함을 약화시킵니다.
 */
